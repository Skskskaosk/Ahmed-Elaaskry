...
client.on('messageCreate', async message => {
    if (message.content.startsWith('$start') && message.author.id === '1259694413014241281') {
        const embed = new EmbedBuilder()
            .setTitle('الدعم الفني')
            .setDescription('اضغط لفتح تذكرة أو عرض القواعد')
            .setColor(0x808080)
            .setImage('https://media.discordapp.net/attachments/1297190957833519147/1297564492632424538/Picsart_24-10-19_15-55-53-107.png')
...
client.on('interactionCreate', async interaction => {
    ...
    if (customId === 'open_ticket') {
        ...
        const logEmbed = new EmbedBuilder()
            ...
            .setColor(0x808080)
            .setImage('https://media.discordapp.net/attachments/1297579534635503689/1297616190042148915/Picsart_24-10-20_19-16-33-274_1.jpg');

        await logChannel.send({ embeds: [logEmbed] });
        await logChannel.send({ content: 'https://media.discordapp.net/attachments/1297579534635503689/1297616200205074574/20241019_144717_0000.png' });
    }
    ...
    if (interaction.isSelectMenu() && interaction.customId === 'ticket_actions') {
        ...
        switch (interaction.values[0]) {
            case 'take_ticket':
                ...
                await logChannelTake.send({ content: 'https://media.discordapp.net/attachments/1297579534635503689/1297616200205074574/20241019_144717_0000.png' });
                break;
            ...
            case 'leave_ticket':
                ...
                await logChannelLeave.send({ content: 'https://media.discordapp.net/attachments/1297579534635503689/1297616200205074574/20241019_144717_0000.png' });
                break;
            ...
            case 'delete_ticket':
                ...
                await logChannelDelete.send({ content: 'https://media.discordapp.net/attachments/1297579534635503689/1297616200205074574/20241019_144717_0000.png' });
                break;
